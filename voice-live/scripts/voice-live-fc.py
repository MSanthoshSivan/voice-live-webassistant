...
class AsyncFunctionCallingClient:
    ...
    def __init__(
        ...
        # Add these new attributes for tracking transcriptions and responses
    ...
    async def _handle_event(self, event, connection):
        ...
        # Add this new event handler for transcription
            ...
            # Reset response accumulator and store response ID
            self.current_response = ""
            ...
            if hasattr(event, 'delta') and event.delta:
                ...
                # logger.info(f"Text response delta: {event.delta}")
            ...
            if self.current_response:
                print(f"🤖 ASSISTANT RESPONSE: {self.current_response}")
                logger.info(f"Complete response: {self.current_response}")
            ...
            if self.current_user_input and self.current_response:
                ...
                print(f"Assistant: {self.current_response}")
                print("="*50 + "\n")
